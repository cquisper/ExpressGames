                ...
                <div class="card-header">
                    <div class="row flex-grow-0">
                        <div class="col-auto align-self-center">
                            <c:choose>
                                <c:when test="${requestScope.tipo eq 'clientes'}">
                                    <h5 class="mb-0" data-anchor="data-anchor">Clientes</h5>
                                    <c:set var="tipo" value="cliente"/>
                                </c:when>
                                <c:when test="${requestScope.tipo eq 'administradores'}">
                                    <h5 class="mb-0" data-anchor="data-anchor">Administradores</h5>
                                    <c:set var="tipo" value="administrador"/>
                                </c:when>
                                <c:otherwise>
                ...
                <div class="card-body pt-0">
                    <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                            ...
                            <div id="tableExample2" data-list='{"valueNames":["ID","Nombre","Apellido", "DNI", "Username", "E-mail", "Rol"],"page":5,"pagination":true}'>
                                    ...
                                    <table class="table table-bordered table-striped fs--1 mb-0">
                                        ...
                                        <c:forEach var="cliente" items="${requestScope.clientes}">
                                            <tr>
                                                ...
                                                <td class="precio">${cliente.apellido}</td>
                                                <td class="dni">${cliente.dni}</td>
                                                <td class="username">${cliente.usuario.username}</td>
                                                <td class="email">${cliente.usuario.email}</td>
                                                <td class="email">${cliente.usuario.password}</td>
                                                <td class="rol">${cliente.usuario.rol.nombre}</td>
                                                    ...
                                                    <div class="dropdown text-center font-sans-serif position-static">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end border py-0" style="">
                                                            <div class="bg-white py-2">
                                                                <a class="dropdown-item" href="${pageContext.request.contextPath}/formulario/${tipo}?idCliente=${cliente.id}">
                                                                    Editar
                                                                </a>
                                                                <a class="dropdown-item text-danger" href="${pageContext.request.contextPath}/eliminar/${tipo}?idCLiente=${cliente.id}">
                                                                    Eliminar
                                                                </a>
                                                            </div>
                                                        </div>
